---
title: "Why I Made My Website Repository Public"
date: 2026-05-17
tags: ["website", "github", "seo", "ai-search", "documentation", "open-source"]
summary: "I moved my website from a private GitHub repository to a public one so the code, content, and documentation around my projects are easier to find, inspect, and improve."
coverImage: "https://files.arvid.tech/blog/website-on-github.webp"
coverImageAlt: "Diagram showing a website and GitHub repository feeding into SEO and AI search indexing."
---
...
So that is the reason for the change. I want the website to be easier to find, easier to understand, and easier to contribute to. Making the repository public is a small step, but it supports all three.
