---
title: "Where should I host my portfolio?"
date: 2024-10-06
tags: ["software-engineering", "hosting"]
summary: "In this blog post, I compare Azure, AWS, and Railway, highlighting why Railway is the best choice for developers, especially students building portfolio websites. Inspired by discussions with my classmates about job readiness. Ready to d..."
---

Recently, my fellow third-year students in my bachelor's program have been thinking about how to land jobs in the software development space once they graduate. One thing that's become clear is the importance of having a portfolio website. My friend [Filip Bengtegård Book](https://www.linkedin.com/in/filip-bengteg%C3%A5rd-book-295483208/?originalSubdomain=se) specifically asked me for some tips, which got me thinking about the best ways to host and deploy these portfolio sites. That's what inspired me to write this comparison of cloud platforms, with a focus on why I believe [Railway](https://railway.app/) is an excellent choice for developers, especially those just starting out.
...
Sorry Microsoft but that is so bad that I don't know which one is worse Azure or [Ling’s Cars](https://lingscars.com/). Ling's Cars website, with its notoriously chaotic design, is easier to navigate than Azure's labyrinthine interface. At least on Ling's Cars, you can find the "Buy a Car" button without needing a treasure map!

_Please note that Ling’s Car actually works on mobile, compared to Azure._
...
> They do however have an amazing [Discord community](https://discord.com/invite/railway).
...
| ✅ Improved but still complex|

| Pricing Model
| ✅ Transparent, per-minute billing
| ❌ Complex with potential hidden costs
| ❌ Pay-as-you-go but can be complex|
...
| Service Variety
| ❌ Limited but focused
| ✅ Extensive (200+ services)
| ✅ Extensive|

| Deployment Speed
| ✅ Very fast (one-click from GitHub)
| ❌ Can be complex
| ✅ Varies by service|

| Automatic Scaling
| ✅ Yes, built-in
| ✅ Available but may require configuration
| ✅ Available but may require configuration|

| Global Infrastructure
| ❌ Limited
| ✅ Extensive (60+ regions)
| ✅ Extensive (30+ regions)|
...
_PS. If I would have recommended Azure or AWS I would have received more money from a referral, but I would rather promote a product I believe in._
