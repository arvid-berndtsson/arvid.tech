...
export const siteConfig: SiteConfig = {
  ...
  social: {
    github: "https://github.com/arvid-berndtsson",
...
/**
 * Returns full page title for meta/head (e.g. "About - Arvid Berndtsson").
 */
...
/**
 * Returns social links with SVG path data for icons (GitHub, LinkedIn).
 */
